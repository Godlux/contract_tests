...
contract Jkp is Ownable {
    ...
    function reval_choise(address _other_player_address, uint8 choice, bytes32 nonce) public returns (bool success) {
        ...
        choises[msg.sender][_other_player_address] = Choice(choice);
        return true;
    }
